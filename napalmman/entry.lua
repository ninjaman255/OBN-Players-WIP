...
function roster_init(info) 
    ...
    info:set_icon_texture(LoadTexture(_modpath.."napalmman_face.png"))
    info:set_preview_texture(LoadTexture(_modpath.."preview.png"))
    info:set_overworld_animation_path(_modpath.."napalmman_OW.animation")
    info:set_overworld_texture_path(_modpath.."napalmman.png")
...
function battle_init(player)
    player:set_name("Napalmman")
    player:set_health(1800)
    player:set_element(Element.Fire)
    player:set_height (160.0)
    print("here 1")
    player:set_animation(_modpath.."napalmman.animation")
    print("here 2")
    player:set_texture(LoadTexture(_modpath.."napalmman_battle.png"), true)
    print("here 3")
