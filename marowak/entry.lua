...
function roster_init(info) 
    ...
    info:set_icon_texture(LoadTexture(_modpath.."marowak_face.png"))
    info:set_preview_texture(LoadTexture(_modpath.."preview.png"))
    info:set_overworld_animation_path(_modpath.."marowakOW.animation")
    info:set_overworld_texture_path(_modpath.."marowakOW.png")
