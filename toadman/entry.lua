...
function roster_init(info) 
    ...
    info:set_icon_texture(LoadTexture(_modpath.."toadman_face.png"))
    info:set_preview_texture(LoadTexture(_modpath.."preview.png"))
    info:set_overworld_animation_path(_modpath.."toadmanOW.animation")
    info:set_overworld_texture_path(_modpath.."toadmanOW.png")
...
function battle_init(player)
    player:set_name("Toadman")
    player:set_health(1200)
    player:set_element(Element.Aqua)
    --player:SlideWhenMoving(true, frames(6))
    player:set_height (80.0)
    print("here 1")
    player:set_animation(_modpath.."toadman_battle.animation")
    print("here 2")
    player:set_texture(LoadTexture(_modpath.."toadman_atlas.png"), true)
    print("here 3")
