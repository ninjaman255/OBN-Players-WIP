function package_init(package)
    package:declare_package_id("com.D3stroy3d.player.Fireman")
    ...
    package:set_overworld_animation_path(_modpath.."fireman_OW.animation")
    package:set_overworld_texture_path(_modpath.."fireman_OW.png")
    package:set_mugshot_texture_path(_modpath.."mug.png")
    package:set_mugshot_animation_path(_modpath.."mug.animation")
end

function player_init(player)
    player:set_name("Fireman")
    player:set_health(2000)
    player:set_element(Element.Fire)
    player:set_height (60.0)
    player:set_animation(_modpath.."fireman_battle.animation")
    player:set_texture(Engine.load_texture(_modpath.."fireman_atlas.png"), true)
