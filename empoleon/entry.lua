function package_init(package)
    package:declare_package_id("com.D3stroy3d.player.Empoleon")
    ...
    package:set_overworld_animation_path(_modpath.."empoleon_OW.animation")
    package:set_overworld_texture_path(_modpath.."empoleon_OW.png")
    package:set_mugshot_texture_path(_modpath.."mug.png")
    package:set_mugshot_animation_path(_modpath.."mug.animation")
end

function player_init(player)
    player:set_name("Empoleon")
