function package_init(package)
    package:declare_package_id("com.D3stroy3d.player.Hatman")
    ...
    package:set_overworld_animation_path(_modpath.."HatmanOW.animation")
    package:set_overworld_texture_path(_modpath.."HatmanOW.png")
    --package:set_mugshot_texture_path(_modpath.."mug.png")
    --package:set_mugshot_animation_path(_modpath.."mug.animation")
end

function player_init(player)
    player:set_name("Hatman")
    player:set_health(2000)
    player:set_element(Element.Break)
    player:set_height (60.0)
    player:set_animation(_modpath.."hatman.animation")
