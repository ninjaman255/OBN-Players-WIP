function package_init(package)
    package:declare_package_id("com.D3stroy3d.player.Chargeman")
    ...
    package:set_overworld_animation_path(_modpath.."chargemanOW.animation")
    package:set_overworld_texture_path(_modpath.."chargemanOW.png")
    package:set_mugshot_texture_path(_modpath.."mug.png")
    package:set_mugshot_animation_path(_modpath.."mug.animation")
end

function player_init(player)
    player:set_name("Chargeman")
