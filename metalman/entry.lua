...
function roster_init(info) 
    ...
    info:set_icon_texture(LoadTexture(_modpath.."metalman_face.png"))
    info:set_preview_texture(LoadTexture(_modpath.."preview.png"))
    info:set_overworld_animation_path(_modpath.."metalmanOW.animation")
    info:set_overworld_texture_path(_modpath.."metalmanOW.png")
...
function battle_init(player)
    ...
    print("here 1")
    player:set_animation(_modpath.."metalman.animation")
    print("here 2")
    player:set_texture(LoadTexture(_modpath.."metalman_atlas.png"), true)
    print("here 3")
