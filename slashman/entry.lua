...
function roster_init(info) 
    ...
    info:set_overworld_animation_path(_modpath.."slashmanOW.animation")
    info:set_overworld_texture_path(_modpath.."slashmanOW.png")
...
function battle_init(player)
    player:set_name("Slashman")
    player:set_health(1600)
    player:set_element(Element.Sword)
    player:set_height (120.0)
    print("here 1")
...
function execute_charged_attack(player)
    ...
    return Battle.Bomb.new(player, 50)
end