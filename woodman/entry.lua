...
function roster_init(info) 
    ...
    info:set_icon_texture(LoadTexture(_modpath.."woodman_face.png"))
    info:set_preview_texture(LoadTexture(_modpath.."preview.png"))
    info:set_overworld_animation_path(_modpath.."woodmanOW.animation")
    info:set_overworld_texture_path(_modpath.."woodmanOW.png")
...
function battle_init(player)
    player:set_name("Woodman")
    player:set_health(2000)
    player:set_element(Element.Wood)
    player:set_height (160.0)
    print("here 1")
    player:set_animation(_modpath.."woodman.animation")
    print("here 2")
    player:set_texture(LoadTexture(_modpath.."woodman_atlas.png"), true)
    print("here 3")
