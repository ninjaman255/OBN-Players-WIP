...
function roster_init(info) 
    ...
    info:set_special_description("A Progs Life")
    info:set_speed(2.0)
    info:set_attack(2)
    ...
    info:set_overworld_animation_path(_modpath.."ProgCompleted.animation")
    info:set_overworld_texture_path(_modpath.."ProgCompleted.png")
