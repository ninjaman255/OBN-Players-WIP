function package_init(package)
    package:declare_package_id("com.D3stroy3d.player.Dustman")
    ...
    package:set_overworld_animation_path(_modpath.."dustmanOW.animation")
    package:set_overworld_texture_path(_modpath.."dustmanOW.png")
    package:set_mugshot_texture_path(_modpath.."mug.png")
    package:set_mugshot_animation_path(_modpath.."mug.animation")
end

function player_init(player)
    player:set_name("Dustman")
