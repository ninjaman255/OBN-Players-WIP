function package_init(package)
    package:declare_package_id("com.D3stroy3d.player.Beastman")
    ...
    package:set_overworld_animation_path(_modpath.."beastmanOW.animation")
    package:set_overworld_texture_path(_modpath.."beastmanOW.png")
